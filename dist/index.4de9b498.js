...
parcelHelpers.export(exports, "cardHolder", ()=>cardHolder);
parcelHelpers.export(exports, "inputCvv", ()=>inputCvv);
parcelHelpers.export(exports, "inputCardNumber", ()=>inputCardNumber);
parcelHelpers.export(exports, "formBtn", ()=>formBtn);
...
},{"./mount.js":"5qTJ0","./unmount.js":"irGDu","./util.js":"84GoL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kedNO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "isValidName", ()=>isValidName);
parcelHelpers.export(exports, "isValidCardNumber", ()=>isValidCardNumber);
parcelHelpers.export(exports, "isValidCVV", ()=>isValidCVV);
var _imask = require("imask");
var _imaskDefault = parcelHelpers.interopDefault(_imask);
var _createJs = require("./create.js");
new (0, _imaskDefault.default)((0, _createJs.inputCardNumber), {
    mask: "0000 0000 0000 0000"
});
new (0, _imaskDefault.default)((0, _createJs.inputCvv), {
    mask: "000"
});
...
(0, _createJs.formBtn).addEventListener("click", ()=>{
    const validName = isValidName((0, _createJs.cardHolder).value);
    const cardNumberValue = (0, _createJs.inputCardNumber).value.replace(/\s/g, "");
    const validCardNumber = isValidCardNumber(cardNumberValue);
    const validCvv = isValidCVV((0, _createJs.inputCvv).value);
    if (validName && validCardNumber && validCvv) (0, _createJs.validationMessage).textContent = "\u0412\u0432\u0435\u0434\u0435\u043D\u044B \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0435 \u0434\u0430\u043D\u043D\u044B\u0435";
    else (0, _createJs.validationMessage).textContent = "\u0412\u0432\u0435\u0434\u0435\u043D\u044B \u043D\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0435 \u0434\u0430\u043D\u043D\u044B\u0435";
    setTimeout(()=>{
        (0, _createJs.validationMessage).textContent = "";
    }, 2000);
});

},{"imask":"aLznl","./create.js":"44Gyy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aLznl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
