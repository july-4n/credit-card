...
const renderCard = () => {
  ...
  const validationMessage = el('h2', {className: 'form__validation-message'}, '');
  const form = el('form', {className: 'form', action: '#', id: 'form'}, [cardHolder, cardNumberForm, cardDateForm, cardCvv, btn, validationMessage]);
